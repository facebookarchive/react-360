...
export interface OverlayInterface {
  ...
  hide(): void;
  setCameraRotation(quat: [number, number, number, number]): void;
  setVRButtonState(visible: boolean, text: string, onClick: ?Handler): void;
  show(): void;
}
...
export default class Overlay implements OverlayInterface {
  ...
  setVRButtonState(visible: boolean, text: string, onClick: ?Handler) {
    if (visible) {
      this.enableVRButton();
    } else {
  ...
  setCameraRotation(quat: [number, number, number, number]) {
