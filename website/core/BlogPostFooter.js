...
var BlogPostFooter = React.createClass({
  render: function() {
    ...
    var authorImage = this.props.post.authorImage ? this.props.post.authorImage : '/react-vr/img/author.png';
      ...
      <div>
        ...
        <aside className="entry-share">
          ...
          <div className="social-buttons">
            ...
            <a href="https://twitter.com/share" className="twitter-share-button" data-text={post.title} data-url={"http://facebook.github.io/react-vr/blog/" + post.path} data-via={post.authorTwitter} data-related="reactnative" data-show-count="false">Tweet</a>
          </div>
        </aside>
      </div>
    );
