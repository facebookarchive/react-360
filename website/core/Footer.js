...
function getGitHubPath(path) {
  return 'https://github.com/facebook/react-vr/blob/master/' + path;
}
  ...
  render: function() {
    ...
    return (
      <p className="edit-page-block">
        You can <a target="_blank" href={'https://github.com/facebook/react-vr/issues'}>file an issue on GitHub</a> if you see a typo or error on this page!
      </p>
    );
  	/*
    return (
