...
function parseSource(source) {
  ...
  if (!result) {
    console.warn('WARNING: parseSource cannot find export definition');
    return null;
  }
  ...
  if (!moduleName) {
    console.warn('WARNING: parseSource cannot find @providesmodule');
    return null;
  }
  ...
  console.warn('WARNING: parseSource failed to find jsdoc data');
  return null;
}
