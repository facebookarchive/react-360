...
export default class RCTText extends ShadowViewWebGL {
  ...
  getTextString(parentColor) {
    if (!this._textDirty) {
      return this._cachedText;
    }

    const color = this._textColor == null ? parentColor : this._textColor;
    const colorString = String.fromCharCode(0) + String.fromCharCode(color >>> 16 & 0xff) + String.fromCharCode(color >>> 8 & 0xff) + String.fromCharCode(color & 0xff) + String.fromCharCode(color >>> 24 & 0xff);
    this._cachedText = '';
