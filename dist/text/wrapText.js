...
const LINE_BREAK = /[\r\n]+$/;
export default function wrapText(impl, font, size, text, fitToWidth, options = {}) {
  const lines = []; // Todo: expose configurable locale once the underlying API has better support
